...
using ClinicApp.AuthorizationAndUserManager.Services;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ClinicBD Authorization and User Manager Microservice", Version = "v1" });
