...
using ClinicApp.MSServiceLogByContractor.Services;
...
builder.Services.AddScoped<IServiceLogByContractor, ServiceLogByContractorService>();
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ClinicBD Client Microservice", Version = "v1" });
