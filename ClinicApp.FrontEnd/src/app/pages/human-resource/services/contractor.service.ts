...
export class ContractorService {
  ...
  createContractor(contractor: Contractor): Observable<Contractor> {
    ...
    return this.http
      .post<Contractor>(this.contractorUrl, contractor, { headers })
      .pipe(
  ...
  updateContractor(
    ...
    partial_modify: boolean
  ): Observable<Contractor> {
    const headers = new HttpHeaders({ "Content-Type": "application/json" });
    const url = `${this.contractorUrl}/${contractor.id}/${partial_modify}`;
    return this.http.put<Contractor>(url, contractor, { headers }).pipe(
  ...
  deleteContractor(Id: number) {
    ...
    return this.http.delete<Contractor>(url, { headers }).pipe(
  ...
  getContractorByCompany(id: Number): Observable<Contractor[]> {
    return this.http
      .get<Contractor[]>(this.contractorUrl + "/getContractorByCompany/" + id)
      .pipe(
  ...
  getContractorWithoutDetails(): Observable<Contractor[]> {
    return this.http
      .get<Contractor[]>(this.contractorUrl + "/getContractorWithoutDetails")
      .pipe(
        tap((data) => console.log(data)),
        catchError(this.handleError)
      );
  ...
  getContractors(data): Observable<PagedResponse<Contractor[]>> {
    ...
    return this.http
      .get<PagedResponse<Contractor[]>>(this.contractorUrl, { params })
      .pipe(
        tap((data) => console.log(data)),
        catchError(this.handleError)
      );
  ...
  getAnalystByCompany(id: number): Observable<Contractor[]> {
    return this.http
      .get<Contractor[]>(`${this.contractorUrl}/GetAnalystByCompany/${id}`)
      .pipe(
        tap((data) => console.log(data)),
        catchError(this.handleError)
      );
  ...
  getContractor(id: number): Observable<Contractor> {
    return this.http.get<Contractor>(`${this.contractorUrl}/${id}`).pipe(
  ...
  getContractortByName(name: string): Observable<PagedResponse<Contractor[]>> {
    return this.http
      .get<PagedResponse<Contractor[]>>(
        `${this.contractorUrl}/GetContractorByName/${name}`
      )
      .pipe(
        tap((data) => console.log(JSON.stringify(data))),
        catchError(this.handleError)
  ...
  sendConfirmationEmail(contractor_id: number): Observable<any> {
    return this.http.post(
      `https://test.register.abaanalystgroup.live/send_email/${contractor_id}`,
      {}
    );
  }
