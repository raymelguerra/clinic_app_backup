...
export class SeviceLogService {
  ...
  deleteServiceLog(id: number) {
    ...
    return this.http.delete<ServiceLog>(url, { headers }).pipe(
  ...
  GetServicesLogsWithoutDetails(): Observable<any[]> {
    return this.http.get<any[]>(this.serviceLogUrl).pipe(
      tap((data) => console.log("All: " + JSON.stringify(data))),
      catchError(this.handleError)
    );
  }
  ...
  getServiceLogsByName(
    ...
    name: string,
    type: string
  ): Observable<PagedResponse<ServiceLog[]>> {
    ...
    return this.http
      .get<PagedResponse<ServiceLog[]>>(
        `${this.serviceLogUrl}/GetServiceLogsByName/${name}/${type}`,
        { params }
      )
      .pipe(
        // timeout(),
  ...
  getServiceLog(data: any): Observable<PagedResponse<ServiceLog[]>> {
    ...
    return this.http
      .get<PagedResponse<ServiceLog[]>>(this.serviceLogUrl, { params })
      .pipe(
        tap((data) => console.log("All: " + JSON.stringify(data))),
        catchError(this.handleError)
      );
  ...
  getServiceLogById(id: number): Observable<any> {
    return this.http.get<any>(`${this.serviceLogUrl}/${id}`).pipe(
      tap((data) => console.log("All: " + JSON.stringify(data))),
      catchError(this.handleError)
    );
  }
  ...
  updatePeriod(serviceLog: any): Observable<any> {
    ...
    return this.http.put<any>(url, serviceLog, { headers }).pipe(
  ...
  getServiceLogPendings(data: any): Observable<PagedResponse<ServiceLog[]>> {
    ...
    return this.http
      .get<PagedResponse<ServiceLog[]>>(
        `${this.serviceLogUrl}/GetPendingServiceLog`,
        { params }
      )
      .pipe(
        tap((data) => console.log("All: " + JSON.stringify(data))),
  ...
  updateStatus(id: number, status: number): Observable<any> {
    const headers = new HttpHeaders({ "Content-Type": "application/json" });
    const url = `${this.serviceLogUrl}/ChangeStatusServiceLog/${id}/${status}`;
    return this.http.patch<any>(url, null, { headers }).pipe(
      tap(() => console.log("updateStatus: " + id)),
      catchError(this.handleError)
    );
  }

  printServiceLog(id: number): Observable<any> {
    let headers = new HttpHeaders({
      responseType: "blob",
      observe: "response",
    });
    console.log(this.url_pdf)
    return this.http.get(`${this.url_pdf}/${id}/pdf`, {
      headers: headers,
      responseType: "blob",
    });
  }
