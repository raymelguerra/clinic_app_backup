...
import { AuthenticationService } from '../../pages/security/authentication.service';
...
export class AdminComponent implements OnInit {
  ...
  public myInitialize() {
    ...
    this.user_rol = localStorage.getItem("role");
    if(this.user_name === null && this.user_rol === null )
      this.router.navigate(["/authentication/login"]);
    
      console.log(`Username: ${this.user_name}, Password: ${this.user_rol}` );
  }
  public logout = () => {
    console.log("IS HERE");
