...
using ClinicApp.MSContractor.Services;
...
builder.Services.AddScoped<IContractor, ContractorService>();
//Add cors support
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ClinicBD Contractor Microservice", Version = "v1" });
