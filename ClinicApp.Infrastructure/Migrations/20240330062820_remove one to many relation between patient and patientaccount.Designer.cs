...
namespace ClinicApp.Core.Migrations
{
    ...
    [Migration("20240330062820_remove one to many relation between patient and patientaccount")]
    partial class removeonetomanyrelationbetweenpatientandpatientaccount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClinicApp.Core.Models.PatientAccount", b =>
                {
                    b.HasOne("ClinicApp.Core.Models.Client", "Client")
                        .WithOne("PatientAccounts")
                        .HasForeignKey("ClinicApp.Core.Models.PatientAccount", "ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
